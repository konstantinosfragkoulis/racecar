...
def update():
    ...
    # Done
        ...
        if contour_center is not None and depth_image[contour_center[0]][contour_center[1]] < 200 and timer > 2:
            cur_state = State.LineFollowing
    ...
    # Small Fix - Active (very low time gain -5-4 seconds)
        ...
        if contour_center is not None and depth_image[contour_center[0]][contour_center[1]] < 450 and timer > 5:
            cur_state = State.LineFollowing
            timer = 0
        elif ar_dist < 50:
            trainEvading2()
